...
public class MessagePackDataformatPojoBenchmarkTest
{
    ...
    private final ObjectMapper origObjectMapper = JsonMapper.builder().build();
    private final ObjectMapper msgpackObjectMapper = new MessagePackMapper(new MessagePackFactory());
