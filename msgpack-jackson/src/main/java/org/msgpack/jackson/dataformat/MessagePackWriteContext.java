 ...
 * @since 2.10
 */
public final class MessagePackWriteContext extends JsonStreamContext
{
    /**
     * Parent context for this context; null for root context.
     */
    protected final MessagePackWriteContext _parent;
    ...
    protected MessagePackWriteContext _childToRecycle;
    ...
    protected MessagePackWriteContext(int type, MessagePackWriteContext parent, DupDetector dups,
                                      Object currentValue) {
        super();
        _type = type;
        _parent = parent;
    ...
    private MessagePackWriteContext reset(int type, Object currentValue) {
        _type = type;
        _index = -1;
    ...
    public MessagePackWriteContext withDupDetector(DupDetector dups) {
        _dups = dups;
        return this;
    }
    ...
    public static MessagePackWriteContext createRootContext(DupDetector dd) {
        return new MessagePackWriteContext(TYPE_ROOT, null, dd, null);
    }

    public MessagePackWriteContext createChildArrayContext(Object currentValue) {
        MessagePackWriteContext ctxt = _childToRecycle;
        if (ctxt == null) {
            _childToRecycle = ctxt = new MessagePackWriteContext(TYPE_ARRAY, this,
    ...
    public MessagePackWriteContext createChildObjectContext(Object currentValue) {
        MessagePackWriteContext ctxt = _childToRecycle;
        if (ctxt == null) {
            _childToRecycle = ctxt = new MessagePackWriteContext(TYPE_OBJECT, this,
                    (_dups == null) ? null : _dups.child(), currentValue);
            return ctxt;
        }
    ...
    @Override public final MessagePackWriteContext getParent() { return _parent; }
     ...
     */
    public MessagePackWriteContext clearAndGetParent() {
        _currentValue = null;
